        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0; ">
              <a href=" " class="site_title" style="    height: 65px; padding-left: 0px;"><img  src="{{ asset('frontendcss/img/logo.jpeg') }}" width="100%" >  </a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                ...
                <img src="{{ asset('frontendcss/img/user.png') }}" alt="..." class="img-circle profile_img" > 
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-briefcase"></i> Category <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-briefcase"></i> Product <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                
                    <li><a href="{{ route('addproduct') }}">Add Product</a></li>
                      <li><a href="{{ route('showproduct') }}">Product List</a></li>
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="{{ asset('frontendcss/img/user.png') }}" alt=""> 
                    </a>
  ...
  @yield('content')
        ...
        <footer>
          <div class="pull-right">
           Copyright © by <a href="https://indeedsolution.com">Indeed Solution </a> 2019-2020 
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
