    ...
    <div class="product_image_area section-padding40">
      <div class="container">
        <div class="row s_product_inner">
          <div class="col-lg-5">
            <div class="product_slider_imgs">
              <div id="verticals" >
                  <center> <img src="{{ asset('images/'.$product->image ) }}" style="width: 250px; height: 400px;"/> </center>
              </div>
            </div>
          </div>
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              ...
              <ul class="list">
                <li>
                  <a class="active" href="#">
                    <span>Category</span> : {{ $product->category[0]->name }}</a>
                  </li>
                  <li>
                    <a href="#"> <span>Availibility</span> : @if($product->quantity > 0) in Stock @else Out of Stock @endif</a>
                  </li>
                </ul>
                <p>
                  {{ $product->description }}
