            ...
            <div class="row">
              <div class="col-md-8 ">
                <div class="x_panel">
                  ...
                  @endif
                    <form class="form-horizontal form-label-left" enctype='multipart/form-data' method="post" action="{{ route('editedproduct') }}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input id="name" class="form-control" required data-validate-length-range="6" data-validate-words="2" name="name" value="{{ $product->name }}"  required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input id="name" class="form-control"  data-validate-length-range="6" data-validate-words="2" name="description"  required="required" value="{{ $product->description }}" type="text">
                        </div>
                      </div> 
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input id="name" class="form-control" required data-validate-length-range="6" data-validate-words="2" name="quantity"  value="{{ $product->quantity }}" required="required" type="number">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input id="name" class="form-control" required data-validate-length-range="6" data-validate-words="2" name="kg"  value="{{ $product->kg }}"  required="required" type="number">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input id="name" class="form-control" required data-validate-length-range="6" data-validate-words="2" name="price"  value="{{ $product->price }}"  required="required" type="text">
                        </div>
                      </div>
